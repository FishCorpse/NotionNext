...
const BLOG = {
  ...
  NOTION_PAGE_ID:
        process.env.NOTION_PAGE_ID || 'f95c6cdbecfb4f39bbf0834616ce97cd',
  ...
  GREETING_WORDS: process.env.NEXT_PUBLIC_GREETING_WORDS || '盛大的戏剧上演，你或可为之献上一曲',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || false, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '木香花湿雨沉沉', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '热爱每一个秋天', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://fragrant.wikidot.com', // 网站地址
  ...
  DESCRIPTION:
        process.env.NEXT_PUBLIC_DESCRIPTION || 'Notion.com', // 站点描述，被notion中的页面描述覆盖
